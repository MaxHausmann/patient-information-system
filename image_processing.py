...
class image_processing:
    ...
    def image_inversion(image_name):                                    
        ar1=image_processing.__image_array_transformation(image_name)
        ...
        return new                                                       #return of the inverted image array
    ...
    def gamma_correction(image_name,gamma):
        ...
        if min_grey<0:                                                   #checking minimum is negativ or positiv
            ...
            return np.int16(new+min_grey)                                #move the array back in the starting area
        else:
    ...
    def smoothing(image_name):
        ...
        return np.int16(new)                                              #return and round 
